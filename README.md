# NOTICE: AN IMPORTANT STATEMENT

THE TEMPLATE FOR THIS REPOSITORY COMES FROM [al-folio](https://github.com/alshedivat/al-folio).

IN ORDER TO KEEP THIS REPOSITORY USERNAME NOT CHANGE, SO DIRECTLY COPIED CODE.

IF YOU `Fork` THIS REPOSITORY, AND DEPLOYED ERROR, SUCH AS `Liquid Exception`, CAN  REFERENCE ORIGIN ISSUE [CLICK HERE](https://github.com/alshedivat/al-folio/issues/1398).

THANK YOU TO THE CONTRIBUTORS OF THE ORIGINAL REPOSITORY, GOOD LUCKY GUYS!
